...
@Entity
@IdClass(ExportSerializable::class)
@Table(name = "t_export_registration")
class ExportRegistration {
    ...
    @Column(name = "declarationdateupdatestatus")
    var declarationDateUpdateStatus:Boolean? = false;

    @Column(name = "inspectiondateupdatestatus")
    var inspectiondateupdatestatus:Boolean? = false;

    @Column(name = "deliverydateupdatestatus")
    var deliverydateupdatestatus:Boolean? = false;

    @Column(name = "possiblepickupdateupdatestatus")
    var possiblepickupdateupdatestatus:Boolean? = false;

    @Column(name = "pickupdateupdatestatus")
    var pickupdateupdatestatus:Boolean? = false;

    @Column(name = "freedateupdatestatus")
    var freedateupdatestatus:Boolean? = false;

    @Column(name = "scheduledatesupdatestatus")
    ...
    constructor(
        ...
        freeTime: Date?,
        declarationDateUpdateStatus: Boolean?,
        inspectiondateupdatestatus: Boolean?,
        deliverydateupdatestatus: Boolean?,
        possiblepickupdateupdatestatus: Boolean?,
        pickupdateupdatestatus: Boolean?,
        freedateupdatestatus: Boolean?,
        scheduledatesupdatestatus: Boolean?,
        createdBy: String?,
        createdDt: Timestamp?,
        updatedBy: String?,
        updatedDt: Timestamp?
        ...
        this.declarationDateUpdateStatus = declarationDateUpdateStatus
        this.inspectiondateupdatestatus = inspectiondateupdatestatus
        this.deliverydateupdatestatus = deliverydateupdatestatus
        this.possiblepickupdateupdatestatus = possiblepickupdateupdatestatus
        this.pickupdateupdatestatus = pickupdateupdatestatus
        this.freedateupdatestatus = freedateupdatestatus
        this.scheduledatesupdatestatus = scheduledatesupdatestatus
